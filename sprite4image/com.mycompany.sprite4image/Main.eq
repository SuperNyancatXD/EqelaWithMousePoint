...
public class Main : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		...
		rsc.prepare_image("j", "JellyFish", get_scene_width()*0.5,get_scene_height()*0.5);
		rsc.prepare_image("p", "Penguins", get_scene_width()*0.5,get_scene_height()*0.5);
		rsc.prepare_image("t", "Tulips", get_scene_width()*0.5,get_scene_height()*0.5);
